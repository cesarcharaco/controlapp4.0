...
class ArriendosController extends Controller
{
    ...
    public function buscar_pagar_arriendo($id)
    {
        ...
        ->join('pagos_has_alquiler','pagos_has_alquiler.id_alquiler','=','alquiler.id')
        ->where('alquiler.id',$id)
        ->select('residentes.*','instalaciones.nombre as instalacion','alquiler.tipo_alquiler as tipo','instalaciones.id as id_instalacion','pagos_has_alquiler.referencia as refer','pagos_has_alquiler.monto','pagos_has_alquiler.status','alquiler.tipo_alquiler as tipo','residentes.id as id_residente')
        ->get();
    }
