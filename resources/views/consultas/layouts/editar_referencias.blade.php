				        	...
				        	<div class="card border border-warning rounded card-tabla shadow p-3 mb-5 bg-white rounded">
				            	<div class="card-body">
					                   ...
					                   <div class="row">
					                       <div class="col-md-12">
					                           <div class="form-group">
					                               ...
					                               <input id="ReferenciaNueva" type="text" name="ReferenciaNueva" max="20" maxlength="20" class="form-control" required placeholder="Nro. de referencia">
					                           </div>
					                       </div>
					                   </div>
					                </center>
							        <div align="center">
							            ...
							            <button type="submit" class="btn btn-warning" id="botonEditarRefe">Editar</button>
							        </div>
							    </div>
				            </div>
				        </div>
