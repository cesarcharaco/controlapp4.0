        ...
        <div class="modal-dialog modals-default">
            <div class="modal-content">
                <div class="modal-header">
                    <h4>Registrar una nueva mensualidad <br> <small>Todos los campos (<b style="color: red;">*</b>) son requerido.</small></h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Especifique el año para la mensualidad <b class="text-danger">*</b></label>
